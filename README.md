...
1. What percentage of vehicles in each state are EVs, PHEVs, HEVs, and gasoline?
    ...
    King Gasoline: With an average of 84% per state,gasoline vehicles maintain overwhelming market share in the United States.
    Main Alternative: Ethanol vehicles with an average of 7.6% per state Dominates the alternate market followed by HEV with an average of 2.3% per state.
    Case with EV: With an average of 0.89% per state ev's are behind.

2. Which states have the highest EV adoption rates, and which states lag behind?

    EV adoption leaders: California(3.41%),District of Columbia(2.60%),Hawaii(2.37%),Washington(2.23%),Nevada(1.85%)
    States that lag behind: North Dakota(0.13%), Mississippi(0.13%), Wyoming(0.17%), West Virginia(0.19%),South Dakota(0.19%)

3. Which alternative fuels (biodiesel, ethanol, hydrogen) are significant vs. niche?

    Hydrogen: Literally no sale in any states except for California(0.05%)
    Ethanol: Has a Meaningful presence in all states.
    Biodiesel: Presence vary between significant and niche, Has much presence in Montana(3.71%) and Wyoming(3.25%) and District of Columbia(0.13%) and Hawaii(0.31%) lag much behind

4. Compare EV adoption in California vs. other large states (e.g., Texas, Florida, New York).

    EV adoption in California is 3.41% and in other big states like Texas(0.89%),Florida(1.37%),New York(1.16%) add upto 3.42%.
...
## 📊 Tableau Visualization
    ...
    <img width="1920" height="1028" alt="Image" src="https://github.com/user-attachments/assets/c4cf079d-023b-485b-a21b-b6f9b3649f30" />
